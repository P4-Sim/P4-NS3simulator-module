...
control MyEgress(inout headers hdr,
    ...
    apply {
        ...
        if (standard_metadata.priority == 3w7) {
            ...
            if (standard_metadata.deq_qdepth > 19w300) {// 队列长度 大于 700
            ...
            if (standard_metadata.deq_qdepth > 19w250) {// 队列长度 大于 450
            ...
            if (standard_metadata.deq_qdepth > 19w150){
            ...
            if (standard_metadata.deq_qdepth > 19w50) {
            ...
            if (standard_metadata.deq_qdepth > 19w30) {
            ...
            if (standard_metadata.deq_qdepth > 19w20) {
